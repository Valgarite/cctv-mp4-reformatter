...
def processOCR(imgURL: str)->dict[str, str, str]:
    best_date_certainty, best_time_certainty = 0 , 0
    best_date, best_time, found_cam = 'NO_DATE', 'NO_TIME', 'NO_CAM'
    previous_word = None
    ...
    try:
        ...
        pass
    return { 'date': best_date, 'time': best_time, 'camera': found_cam, 'best_date_certainty': best_date_certainty, 'best_time_certainty': best_time_certainty}
